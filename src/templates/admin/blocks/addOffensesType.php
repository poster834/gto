<h3>Добавить новый тип нарушения</h3>
            <form id="offensesTypesAddForm" action="" method="post">
                <label class="editInput" for="name"><b>Имя:</b></label> <input class="editInput" name="name" type="text" value="">
                <br>
               <br>
            </form>
            <div class='btn btn-success' onclick="save('offensesTypes')"><i class="fa fa-save" aria-hidden="true"> Сохранить</i></div>
